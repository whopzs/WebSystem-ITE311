            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <small class="form-text text-muted d-block mt-2">
                            <i class="bi bi-info-circle me-1"></i>
                            Get notified when your enrollment requests are approved or rejected
                        </small>
                    </div>
                    <div class="mb-3">
                        <div class="form-check form-switch form-switch-lg">
                            <input class="form-check-input" type="checkbox" id="announcementNotifications" checked>
                            <label class="form-check-label fw-bold" for="announcementNotifications">
                                Announcements
                            </label>
                        </div>
                        <small class="form-text text-muted d-block mt-2">
                            <i class="bi bi-info-circle me-1"></i>
                            Receive notifications for new announcements from teachers
                        </small>
                    </div>
                    <div class="mb-3">
                        <div class="form-check form-switch form-switch-lg">
                            <input class="form-check-input" type="checkbox" id="gradeNotifications" checked>
                            <label class="form-check-label fw-bold" for="gradeNotifications">
                                Grade Updates
                            </label>
                        </div>
                        <small class="form-text text-muted d-block mt-2">
